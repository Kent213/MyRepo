...
static String[] Student = new String[] {"Kent","Jrmy"};
  ...
  {
    return Student[studentNumber-1];
  }
  ...
  public static String getInput()
  {
    ...
    System.out.println("Enter an integer between 1 and 2 inclusive: ");
    ...
    while (!isInteger(input) || Integer.parseInt(input) > 5 || Integer.parseInt(input) < 1)
    {
      ...
      System.out.println("Please enter an integer between 1 and 2 inclusive: ");
